  ...
  describe String do
    describe "#to_money" do
      ...
      STRING_TO_MONEY = {
        ...
        "100.31"          => Money.new(100_31)            ,
        "100,32"          => Money.new(100_32)            ,
        ...
        "100.330 EUR"     => Money.new(100_330_00, "EUR") ,
        "100,340 EUR"     => Money.new(100_34, "EUR")     ,

        "100 USD"         => Money.new(100_00, "USD")     ,
        "-100 USD"        => Money.new(-100_00, "USD")    ,
        "100 EUR"         => Money.new(100_00, "EUR")     ,
        "100.35 EUR"      => Money.new(100_35, "EUR")     ,
        "100,36 EUR"      => Money.new(100_36, "EUR")     ,
        #"100,001.00 USD"  => Money.new(100_001_00, "USD") ,
        #"100.002,00 USD"  => Money.new(10_000, "USD") ,
        #"100.001,00 EUR"  => Money.new(100_001_00, "EUR") ,
        #"100,002.00 EUR"  => Money.new(100_02, "EUR") ,
        ...
        #"USD 100.000,00"  => Money.new(100_00, "USD") ,
        #"EUR 100.000,00"  => Money.new(100_000_00, "EUR") ,
        #"EUR 100,000.00"  => Money.new(100_00, "EUR") ,
